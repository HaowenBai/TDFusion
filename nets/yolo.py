...
from nets.backbone_OD import Backbone, C2f, Conv
from nets.yolo_training import weights_init
from nets.utils_bbox import make_anchors
...
class YoloBody(nn.Module):
    def __init__(self, num_classes, phi, pretrained=False):
        ...
        self.stride     = torch.tensor([256 / x.shape[-2] for x in self.backbone.forward(torch.zeros(1, 1, 256, 256))])  # forward
